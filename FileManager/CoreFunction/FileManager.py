...
from RemoteManagerABC import RemoteManagerABC
from FileFormatABC import FileFormatABC
from FileInterpreterABC import FileInterpreterABC
...
class FileManager:
    ...
    """
    def __init__(self, interpreter: FileInterpreterABC, base_dir: str | Path | None = None, remote_manager: RemoteManagerABC | None = None) -> None:
        """
        ...
        self.remote_manager: RemoteManagerABC | None = None
    ...
    async def _read(self, file: str | Path, check_exists = True, sanitize = True) -> FileFormatABC:
        ...
        formatted: FileFormatABC = self.interpreter.read(contents)
        return formatted

    async def read(self, file: str | Path) -> FileFormatABC:
    ...
    async def _write(self, file: str | Path, formatted: FileFormatABC, create_if_none = False, sanitize = True) -> None:
    ...
    async def write(self, file: str | Path, formatted: FileFormatABC, create_if_none = False) -> None:
